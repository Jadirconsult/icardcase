        ...
        <div className="surface-card relative overflow-hidden edge-highlight">
          ...
          <div className="relative grid gap-12 p-10 sm:p-14 lg:grid-cols-12 lg:gap-16 lg:p-20">
            {/* Coluna esquerda — copy editorial.
                Kickers e números com accent-text: dentro do card (surface-1,
                surface-2 no hover) o accent-hover do .section-kicker dava
                4.35:1 — abaixo de AA para texto de 12px. */}
            <Reveal className="lg:col-span-7">
              <p className="section-kicker text-accent-text">Próximo passo</p>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-3">
                <WhatsAppButton origem="final_cta" variant="primary" className="group">
            ...
            <Reveal delay={90} className="lg:col-span-5 lg:border-l lg:border-hairline lg:pl-16">
              <p className="section-kicker text-accent-text">Como acontece</p>
              <ul className="mt-6 space-y-5">
                {passos.map((s) => (
                  <li key={s.step} className="flex items-start gap-4">
                    <span className="font-mono text-[0.7rem] tracking-[0.12em] text-accent-text pt-1">
                      {s.step}
                    </span>
